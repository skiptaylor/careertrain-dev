class Email
  ...
  def self.welcome(email, first_name, last_name, high1, high2)

    body = ""
    body << "<p>Hello #{first_name} #{last_name}. Welcome to eCareerDirecrion.</p>"
    body << "<p>Your personalized interest report indicates your main interest is <b>#{exercise.high1}</b> and your next interest is <b>#{exercise.high2}.</b> You can return to your account any time to see your scores and watch videos or take the exercise a second time.</p>"
